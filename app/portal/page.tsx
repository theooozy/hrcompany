    ...
    <div className={`bg-white rounded-2xl p-5 shadow-sm border transition-all hover:shadow-md ${ch.featured ? 'border-blue-300 ring-1 ring-blue-200' : 'border-slate-100'}`}>
      ...
      {ch.link && (
        <a href={ch.link} target="_blank" rel="noopener noreferrer"
          className="flex items-center gap-1.5 mb-3 text-xs text-red-600 hover:text-red-700 font-medium bg-red-50 hover:bg-red-100 px-3 py-1.5 rounded-lg transition-all w-fit">
          ▶ 유튜브 채널 바로가기
        </a>
      )}
