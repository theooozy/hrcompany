        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <h1 className="text-6xl md:text-8xl font-black leading-[1.05] tracking-tight mb-3">
              <span className="bg-gradient-to-r from-blue-400 via-violet-400 to-pink-400 bg-clip-text text-transparent">광고대행사가</span>
            </h1>
            <h1 className="text-6xl md:text-8xl font-black leading-[1.05] tracking-tight text-white">아닙니다.</h1>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-6 mb-10">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-sm text-gray-500">자체 채널</span>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-white">500만</span>
              <span className="text-sm text-gray-500">구독자</span>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-white">15억+</span>
              <span className="text-sm text-gray-500">월 조회수</span>
            </div>
          </div>
          <button onClick={() => setShowForm(true)}
      ...
      <section className="py-32 px-6 relative">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs tracking-[0.3em] text-gray-500 mb-4 font-medium">WHY HR</p>
            <h2 className="text-4xl md:text-5xl font-black text-white">우리가 다른 이유</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] transition-all duration-300">
              <div className="text-3xl mb-4">🎯</div>
              <h3 className="text-lg font-bold text-white mb-2">영업 없이 콘텐츠에 집중</h3>
              <p className="text-gray-400 text-sm leading-relaxed">불필요한 영업 과정 없이 콘텐츠 품질에만 집중합니다.</p>
            </div>
            <div className="p-8 rounded-2xl border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] transition-all duration-300">
              <div className="text-3xl mb-4">🏠</div>
              <h3 className="text-lg font-bold text-white mb-2">외주 없이 인하우스 제작</h3>
              <p className="text-gray-400 text-sm leading-relaxed">모든 제작을 내부 팀이 직접 진행합니다.</p>
            </div>
            <div className="p-8 rounded-2xl border border-white/[0.08] bg-white/[0.03] hover:bg-white/[0.06] transition-all duration-300">
              <div className="text-3xl mb-4">✅</div>
              <h3 className="text-lg font-bold text-white mb-2">전 과정 직접 실행</h3>
              <p className="text-gray-400 text-sm leading-relaxed">기획부터 제작, 집행까지 모든 과정을 직접 관리합니다.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
          <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 relative">
            <button onClick={() => { setShowForm(false); setSubmitted(false) }}
              className="absolute top-5 right-5 text-gray-400 hover:text-gray-600 text-xl font-bold w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-all">X</button>
            {submitted ? (
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900 mb-1">브랜드 광고 문의</h2>
                <p className="text-gray-400 text-sm mb-6">담당자가 확인 후 빠르게 연락드립니다</p>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">회사명</label>
                    <input type="text" placeholder="회사 또는 브랜드명" required
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">담당자 이름</label>
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1.5">문의 내용 (선택)</label>
