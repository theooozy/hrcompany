                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
                            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 relative">
                                        <button onClick={() => { setShowForm(false); setSubmitted(false) }}
                                                        className="absolute top-5 right-5 text-gray-400 hover:text-gray-600 text-xl font-bold w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-all">✕</button>button>
                              {submitted ? (
                                  ...
                                  <>
                                    ...
                                    { label: '이메일', key: 'email', placeholder: 'contact@example.com', type: 'email' },
                                                                    ...
                                                                    <div>
                                                                                        <label className="block text-sm font-semibold text-gray-700 mb-1.5">문의 내용 <span className="text-gray-400 font-normal">(선택)</span>span></label>label>
